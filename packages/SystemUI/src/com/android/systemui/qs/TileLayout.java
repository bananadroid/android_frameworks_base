...
public class TileLayout extends ViewGroup implements QSTileLayout {
    ...
    protected int getCellHeight() {
        if (BananaUtils.getQSTileLabelHide(mContext)) {
    ...
    public int getResourceColumnsPortrait() {
        ...
        return BananaUtils.getQSColumnsPortrait(mContext, resourceColumns);
    }
    ...
    public int getResourceColumnsLand() {
        ...
        return BananaUtils.getQSColumnsLandscape(mContext, resourceColumnsLand);
    }
