...
class OngoingPrivacyChip @JvmOverloads constructor(
    ...
    private fun updateView() {
        back.background = if (expanded && networkTrafficInSb) backgroundDrawable else null
        val padding = if (expanded && networkTrafficInSb) sidePadding else 0
        ...
        fun setIcons(chipBuilder: PrivacyChipBuilder, iconsContainer: ViewGroup) {
            ...
            chipBuilder.generateIcons().forEachIndexed { i, it ->
                ...
                if (i != 0) {
                    ...
                    lp.marginStart = if (expanded && networkTrafficInSb) iconMarginExpanded else iconMarginCollapsed
        ...
        if (!privacyList.isEmpty()) {
            ...
            lp.gravity = Gravity.CENTER_VERTICAL or
                    (if (expanded && networkTrafficInSb) Gravity.CENTER_HORIZONTAL else Gravity.END)
